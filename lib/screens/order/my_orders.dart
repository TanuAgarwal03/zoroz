...
class _MyOrdersState extends State<MyOrders> {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //   children: [
                                    //     Text('Payment Status :'),
                                    //     Text('${items[0]["orderStatus"]}', style: TextStyle(color: Colors.red ),),
                                    //   ],
                                    // ),),
                                    ...
                                    //                 BorderRadius.circular(8),
                                    //             child: Image.network(
                                    //               item['image'] ?? 'https://img.myipadbox.com/upload/store/product_l/${item['itemNo']}.jpg',
                                    //               width: 80,
                                    //               height: 80,
                                    //               fit: BoxFit.cover,
                                    //             ),
                                    ...
                                    children: [
                                      if (_activeFilter == 'newest')
                                        const Icon(Icons.check,
                                            size: 16, color: IKColors.primary),
                                      if (_activeFilter != 'newest')
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: const Align(
                    alignment: Alignment.center,
                    child: Text('Order Details', // ✅ Show order date
                        style: TextStyle(
                            color: Colors.black,
                            fontSize: 18,
  ...
  String formatDate(String isoDate) {
    try {
      ...
      return isoDate; // fallback in case of error
    }
  }
}
